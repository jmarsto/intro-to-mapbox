...
class MapTileEight extends Component {
  constructor(props) {
    super(props)
  }
  ...
  componentDidMount() {
    ...
    map.on("load", () => {
      ...
      map.on('mouseenter', 'points', function (e) {
        ...
        display.innerText = `Feature: ${name}`
      });

      map.on('mouseleave', 'points', function() {
        map.getCanvas().style.cursor = '';
        display.innerText = 'Feature: '
      });
    })
  }
  ...
  render() {
    ...
    return(
      <div id="map">
        ...
        <h4 className="display" id="display">Feature: </h4>
      </div>
    )
  }
}

export default MapTileEight;
